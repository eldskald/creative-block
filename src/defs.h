...
#define OPENING_SCREEN_TITLE "CREATIVE BLOCK"
#define OPENING_SCREEN_TITLE_Y 120
#define OPENING_SCREEN_MSG "press enter to start"
#define OPENING_SCREEN_MSG_Y 200
#define OPENING_SCREEN_MSG_CYCLE_TIME 5.0f
